...
```bash
git clone https://github.com/BarberModulator/adhd-447.git
cd adhd-447
npm install
npm start
```
...
[![CI](https://github.com/BarberModulator/adhd-447/actions/workflows/ci.yml/badge.svg)](https://github.com/BarberModulator/adhd-447/actions/workflows/ci.yml)
...
- 🔬 An independent **[evidence-based research review](https://github.com/testdouble/han/blob/adhd-swarm-research/docs/research/adhd-application-to-han.md)** (11 sources, 8 validation rounds) was published against the method — findings tracked openly as [issues #16–#18](https://github.com/BarberModulator/adhd-447/issues).
...
| [**han**](https://github.com/testdouble/han) | Published an [evidence-based research application](https://github.com/testdouble/han/blob/adhd-swarm-research/docs/research/adhd-application-to-han.md) of ADHD onto Han's plugin model — 11 sources, 8 validation rounds. Findings landed as issues [#16](https://github.com/BarberModulator/adhd-447/issues/16)–[#18](https://github.com/BarberModulator/adhd-447/issues/18). | ✅ Research integration |
...
Shipping ADHD in your project? Open a PR adding it here, or [open an issue](https://github.com/BarberModulator/adhd-447/issues/new) and we'll add you.
...
- [**Han plugin compatibility analysis**](https://github.com/testdouble/han/blob/adhd-swarm-research/docs/research/adhd-application-to-han.md) by [@mxriverlynn](https://www.reddit.com/user/mxriverlynn) — evidence-based review using Han's own `/research` skill, 11 sources, 8 validation rounds. Findings tracked as issues [#16](https://github.com/BarberModulator/adhd-447/issues/16), [#17](https://github.com/BarberModulator/adhd-447/issues/17), [#18](https://github.com/BarberModulator/adhd-447/issues/18).
...
<!-- Last updated: 2026-06-06 19:32:27 -->
